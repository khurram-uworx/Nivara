...
public class TypeSafetyTests
{
    ...
    [Test]
    public void Float32_ZeroAndOne_HaveCorrectValues()
    {
        // Act & Assert
        Assert.That(Float32.Zero, Is.EqualTo(0.0f));
        Assert.That(Float32.One, Is.EqualTo(1.0f));
    }

    [Test]
    public void Float32_FromDouble_ConvertsCorrectly()
    {
        // Act
        var result = Float32.FromDouble(3.14);

        // Assert
        Assert.That(result, Is.EqualTo(3.14f).Within(0.0001f));
    }

    [Test]
    public void Float32_ToDouble_ConvertsCorrectly()
    {
        // Act
        var result = Float32.ToDouble(3.14f);
    ...
    [Test]
    public void Float64_ZeroAndOne_HaveCorrectValues()
    {
        // Act & Assert
        Assert.That(Float64.Zero, Is.EqualTo(0.0));
        Assert.That(Float64.One, Is.EqualTo(1.0));
    }

    [Test]
    public void Float64_FromDouble_ConvertsCorrectly()
    {
        // Act
        var result = Float64.FromDouble(3.14);
    ...
    [Test]
    public void Float64_ToDouble_ConvertsCorrectly()
    {
        // Act
        var result = Float64.ToDouble(3.14);

...
dotnet run --project samples/NivaraIncident.Cli -- generate --dataset ./samples/data/incident-lab --scenario A --scale 1

# Run all five analyses
dotnet run --project samples/NivaraIncident.Cli -- analyze --dataset ./samples/data/incident-lab --scenario A

# Benchmark (times each analysis)
dotnet run --project samples/NivaraIncident.Cli -- analyze --benchmark --dataset ./samples/data/incident-lab --scenario A

# Benchmark all scenarios
dotnet run --project samples/NivaraIncident.Cli -- analyze --benchmark --dataset ./samples/data/incident-lab --scenario all

# Streaming vs eager measurement
dotnet run --project samples/NivaraIncident.Cli -- bench-stream --dataset ./samples/data/incident-lab --scenario A

# Kernel vectorization report
dotnet run --project samples/NivaraIncident.Cli -- bench-kernels --dataset ./samples/data/incident-lab --scenario A

# Run analyses with chunked streaming output
dotnet run --project samples/NivaraIncident.Cli -- analyze --dataset ./samples/data/incident-lab --scenario A --stream --chunk-size 50000

# Replay Parquet row groups with chunk-by-chunk progress
dotnet run --project samples/NivaraIncident.Cli -- replay --dataset ./samples/data/incident-lab --scenario A --chunk-size 100000

# Run Streamix streaming scenarios (fault-tolerant, windowed analytics, online AutoDiff learning)
dotnet run --project samples/NivaraIncident.Cli -- streamix --dataset ./samples/data/incident-lab --scenario A
```
...
| `--dataset <path>` | `./samples/data/incident-lab` | Dataset output/input directory |
...
dataset (generate first: `dotnet run --project samples/NivaraIncident/NivaraIncident.Cli -- generate --dataset ./samples/data/incident-lab --scenario A --scale 1`).

**Nivara-only analysis timings:**

```powershell
dotnet run --project samples/NivaraIncident/NivaraIncident.Cli -c Release \
  -- analyze --benchmark --dataset ./samples/data/incident-lab --scenario A
```

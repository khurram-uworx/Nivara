...
#   Torch-parity .bin fixtures used by QwenInstructParityTests (tests/Nivara.Tests) are generated by
#   Python/qwen_tool_reference.py and Python/qwen_plain_reference.py — run them after downloading the
#   checkpoint, otherwise those parity tests skip (Assert.Ignore) until the fixtures exist.
